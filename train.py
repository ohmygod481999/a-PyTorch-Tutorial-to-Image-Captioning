...
checkpoint = "/content/drive/MyDrive/lame_caption_recommendation/model/checkpoint_flickr30k_5_cap_per_img_5_min_word_freq.pth.tar"  # path to checkpoint, None if none
